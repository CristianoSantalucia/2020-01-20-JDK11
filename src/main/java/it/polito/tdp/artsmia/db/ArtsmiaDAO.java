...
public class ArtsmiaDAO
{
	...
	public void getVertici(Map<Integer, Artist> vertici, String ruolo)
	{
	...
	public List<Adiacenza> getAdiacenze(Map<Integer, Artist> vertici)
	{
		String sql = "SELECT a1.artist_id id1, a2.artist_id id2, COUNT(*) peso "
		...
		try
		{
			...
			while (res.next())
			{
				Artist a1 = vertici.get(res.getInt("id1"));
				Artist a2 = vertici.get(res.getInt("id2"));
